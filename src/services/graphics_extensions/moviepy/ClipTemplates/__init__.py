from src.services.graphics_extensions.moviepy.ClipTemplates.TitleClip import TitleClip
from src.services.graphics_extensions.moviepy.ClipTemplates.EndClip import EndClip
