...
from app.services.rendering_services.graphics_extensions.opencv import helpers
...
def make_moving_object_frame(clip, speed=150, object_path='./res/images.png', direction='right'):
    ...
    def make_frame(t):
        ...
        img = app.services.rendering_services.graphics_extensions.opencv.helpers.common.add_as_transparent_image(img, object_img)
        height, width, c = img.shape
