...
from app.rendering_services.graphics_extensions.moviepy.ClipComponents.BaseComponentClip import BaseComponentClip


class PageNumberClip(BaseComponentClip):
    def __init__(self, template, page_number, total_pages, start_time, duration) -> None:
