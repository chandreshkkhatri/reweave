...
from microservices.commons.classes.dataclasses import VideoTemplate
from microservices.commons.enums.attributes import Position
import microservices.rendering_services.graphics_extensions.moviepy.ClipComponents as cc
